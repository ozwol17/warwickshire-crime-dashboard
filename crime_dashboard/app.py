...
st.image("top 5 crime types.png", use_container_width=True)

st.header("2. Top 20 Locations with Most Crimes")
st.image("top 20 locations with most crimes.png", use_container_width=True)
...
st.image("total crime count.png", use_container_width=True)
...
st.image("monthly crime counts by type.png", use_container_width=True)

st.header("7. Monthly Crime Trends by Crime Type")
st.image("monthly crime type in.png", use_container_width=True)

st.header("8. Crime Type Distributions")
st.image("crime type distributions.png", use_container_width=True)
